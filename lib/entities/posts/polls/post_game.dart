...
class PostGame extends Equatable {
  ...
  /// Allows to create an empty [PostGame] object.
  factory PostGame.empty() {
    return PostGame(
      question: '',
  ...
  /// Takes the given [json] JSON object and creates a [PostGame] from it.
  factory PostGame.fromJson(Map<String, dynamic> json) {
    return _$PostGameFromJson(json);
  }
